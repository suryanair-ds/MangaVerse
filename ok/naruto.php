...
<body>
    ...
    <section class="background8 firstsection">
        <div class="photo">
            <img src="../icons/naruto.webp" width="450px" alt="naruto">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="naruto"');
