...
<body>
    <nav class="navbar background3">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./death.php">DeathNote</a></li>
    ...
    <section class="background3 firstsection">
        <div class="photo">
            <img src="../icons/death.jpg" width="450px" alt="deathnote">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="deathnote"');
