...
<body>
    <nav class="navbar background">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./demon.php">Fruit Basket</a></li>
    ...
    <section class="background firstsection">
        <div class="photo">
            <img src="../icons/maid.webp" alt="BERSERK">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="fruit basket"');
