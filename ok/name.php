...
<body>
    <nav class="navbar background7">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./name.php">Your name</a></li>
    ...
    <section class="background7 firstsection">
        <div class="photo">
            <img src="../icons/your.jpg" width="450px" alt="your name">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="your name"');
...
?>
    ...
    <p>Author : Natsuki Takaya</p>
            <div><a href="https://drive.google.com/file/d/1ht5VeY6edkq49YOLLqGFnrgu3RXTn6Gb/view?usp=sharing">
