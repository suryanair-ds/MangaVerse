...
<head>
    ...
    <title>Love is Hard for an Otaku</title>
    
</head>
<body>
    <nav class="navbar background10">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="../after.php#title3">Romance</a></li>
                <li>/</li>
                <li><a href="./otaku.php">Love is hard for otaku</a></li>
    ...
    <section class="background10 firstsection">
        <div class="photo">
            <img src="../icons/lov.jpg" alt="love is hard for otaku">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="love is hard for otaku"');
...
?>
        <div class="text">
            <h1 class="head">LOVE IS HARD FOR AN OTAKU</h1>
            <p>About : 
