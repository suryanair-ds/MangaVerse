...
<body>
    <nav class="navbar background13">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./tokyo.php">Tokyo ghoul</a></li>
    ...
    <section class="background13 firstsection">
        <div class="photo">
            <img src="../icons/ghoul.jpg" alt="tokyo ghoul">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="tokyo ghoul"');
