...
<head>
    ...
    <title>Hitorijime my Hero</title>
    
</head>
<body>
    <nav class="navbar background6">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./myhero.php">Hitorijime my hero</a></li>
    ...
    <section class="background6 firstsection">
        <div class="photo">
            <img src="../icons/hitorijime.jpg" alt="my hero">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="hitorijime my hero"');
...
?>
        <div class="text">
            <h1 class="head">HITORIJIME MY HERO</h1>
            <p>About : 
