...
<body>
    <nav class="navbar background14">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./demon.php">Demon slayer</a></li>
    ...
    <section class="background14 firstsection">
        <div class="photo">
            <img src="../icons/ds.jpg" width="450px" alt="demon slayer">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="demon slayer"');
