...
<body>
    <nav class="navbar background4">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./given.php">Given</a></li>
    ...
    <section class="background4 firstsection">
        <div class="photo">
            <img src="../icons/given.jpg" alt="given">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="given"');
