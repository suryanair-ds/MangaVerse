...
<style media="screen">
    ...
    <nav class="navbar background1">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./attack.php">Attack on titan</a></li>
    ...
    <section class="background1 firstsection">
        <div class="photo">
            <img src="../icons/aot.jpg" width="450px" alt="ATTACK ON TITAN">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="attack on titan"');
...
?>
        ...
        <div class="text">
            <h1 class="head">ATTACK ON TITAN</h1>
            <p>About : 
            Attack on Titan (Japanese: 進撃の巨人, Hepburn: Shingeki no Kyojin, lit. 'The Advancing Giant') is a Japanese dark fantasy anime television series, adapted from the manga series of the same name by Hajime Isayama. The series premiered on April 7, 2013.</p>
