...
<head>
    ...
    <title>Sasaki to Miyano</title>
    
</head>
<body>
    <nav class="navbar background11">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="../after.php#title2">Yaoi</a></li>
                <li>/</li>
                <li><a href="./sasaki.php">Sasaki and miyano</a></li>
    ...
    <section class="background11 firstsection">
        <div class="photo">
            <img src="../icons/sasaki.webp" alt="sasaki">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="sasaki and miyano"');
...
?>
        <div class="text">
            <h1 class="head">SASAKI AND MIYANO</h1>
            <p>About : 
    Fruits Basket, sometimes abbreviated
    Furuba or Fruba, is a Japanese manga
    series written and illustrated by Natsuki Takaya.
    It was serialized in the semi-monthly Japanese shōjo manga magazine 
    Hana to Yume, published by Hakusensha, from 1998 to 2006.</p>
    <p>Author : Natsuki Takaya</p>
            <div><a href="https://drive.google.com/file/d/1ht5VeY6edkq49YOLLqGFnrgu3RXTn6Gb/view?usp=sharing" download="yourname">
