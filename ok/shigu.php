...
<body>
    <nav class="navbar background12">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./shigu.php">Shigurui</a></li>
    ...
    <section class="background12 firstsection">
        <div class="photo">
            <img src="../icons/shig.jpg" alt="shigurui">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="shigurui"');
