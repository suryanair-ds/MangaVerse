...
<body>
    <nav class="navbar background5">
        <div class="logo"><img src="../icons/logo.jpg" alt="logo"><p class="name"><span class="namem">m</span>anga<span class="plus">+</span></p></div>
            ...
            <ul class="nav-list">
                ...
                <li>/</li>
                <li><a href="./kami.php">Kamisama kiss</a></li>
    ...
    <section class="background5 firstsection">
        <div class="photo">
            <img src="../icons/kamisama.jpg" alt="kamisama">
        </div>
...
$posts= mysqli_query($con,'SELECT * FROM mangas WHERE name="kamisama kiss"');
...
?>
        <div class="text">
            <h1 class="head">KAMISAMA  KISS</h1>
            <p>About : 
